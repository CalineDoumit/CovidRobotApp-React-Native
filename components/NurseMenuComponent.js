...
const renderNurseMenuItem = (props) => {
    ...
    return (
        ...
        <Card>
            ...
            {item.isOccupied ? <Text style={{ margin: 10 }}>Room is Occupied</Text> : <Text style={{ margin: 10 }}>Room is empty</Text>}
        </Card>
        </View>
            ...
            return (
                <ScrollView>
                    <FlatList
                        ...
                        renderItem={renderNurseMenuItem}
                        keyExtractor={item => item._id.toString()}
                    />

                    <renderNurseMenuItem item={this.props.robots.robots} />
                </ScrollView>
            );
        }
    }
