...
class NurseMenu extends Component {
    ...
    render() {
        ...
        if (this.props.robots.isLoading) {
            ...
            return (
                <View>
                    <Text>{props.robots.errMess}</Text>
                </View>
            );
        }
        else {
